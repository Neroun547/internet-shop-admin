<template>
  ...
  <main class="wrapper__article-editor">
    ...
    <v-btn class="bg-yellow-accent-4 mt-5 ml-auto d-block" @click="saveArticle"
      >Завантажити статтю</v-btn
    >
  </main>
</template>
<script setup>
...
async function saveArticle() {
  ...
  try {
    ...
    articleUploadedSuccessfulMessage.value = "Статтю завантажено успішно";
  } catch {
    articleUploadErrorMessage.value = "Помилка завантаження статті";
  }
}
</script>
<style>
